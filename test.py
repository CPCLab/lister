...
class Test_lister(unittest.TestCase):
    ...
    def test_extract_kv(self):
        ...
        key = 'cut'
        val = '8 Å'
        self.assertEqual(lister.extract_kv(str1)[0], key)
        self.assertEqual(lister.extract_kv(str1)[1], val)
    ...
    def test_extract_flow_type(self):
        ...
        # [[2, 'step type', 'conditional'], [2, 'flow type', 'if'], [2, 'flow parameter', 'membrane simulation'],
        #  [2, 'flow logical parameter', 'e'], [2, 'flow compared value', 'true']]
        # < elif | membrane
        # simulation | e | false >
        # [[2, 'step type', 'conditional'], [2, 'flow type', 'elif'], [2, 'flow parameter', 'membrane simulation'],
        #  [2, 'flow logical parameter', 'e'], [2, 'flow compared value', 'false']]
        ...
        # < elif | water
        # type | e | OPC >
        # [[4, 'step type', 'conditional'], [4, 'flow type', 'elif'], [4, 'flow parameter', 'water type'],
        #  [4, 'flow logical parameter', 'e'], [4, 'flow compared value', 'OPC']]
        # < if | membrane simulation | e | true >
        # [[4, 'step type', 'conditional'], [4, 'flow type', 'if'], [4, 'flow parameter', 'membrane simulation'],
        #  [4, 'flow logical parameter', 'e'], [4, 'flow compared value', 'true']]
        # < if | membrane simulation | e | true >
        # [[5, 'step type', 'conditional'], [5, 'flow type', 'if'], [5, 'flow parameter', 'membrane simulation'],
        #  [5, 'flow logical parameter', 'e'], [5, 'flow compared value', 'true']]
        # < elif | membrane
        # simulation | e | false >
        # [[5, 'step type', 'conditional'], [5, 'flow type', 'elif'], [5, 'flow parameter', 'membrane simulation'],
        #  [5, 'flow logical parameter', 'e'], [5, 'flow compared value', 'false']]
        # < Section | Minimization >
        # [['-', 'section', 'Minimization']]
