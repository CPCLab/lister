...
class InitialGUI(GeneralGUI):
    ...
    def create_widgets(self):
        ...
        ttk.Style().configure('Font.TLabelframe', background="#ebebec")

        # REQUIRED ARGUMENT FRAME
        self.req_label_frame = ttk.LabelFrame(master=self, text="Required arguments", style="Font.TLabelframe")
        self.req_label_frame.grid(row=1, column=0, sticky="nswe", padx=10, pady=(30,10))
        self.required_argument_frame = customtkinter.CTkFrame(master=self.req_label_frame, width=100)
        ...
        self.output_filename_label = customtkinter.CTkLabel(
            master=self.required_argument_frame, text="Output File Name:", justify="right", anchor=customtkinter.W, text_font=("", '10','bold'))
        ...
        self.elabftw_id_label = customtkinter.CTkLabel(
            master=self.required_argument_frame, text="eLabFTW Experiment ID:", text_font=("", '10','bold'))
        ...
        self.elabftw_id_info = customtkinter.CTkLabel(
            ...
            text="Integer indicated in the URL of the experiment.")
        ...
        self.elabftw_endpoint_label = customtkinter.CTkLabel(
            master=self.required_argument_frame, text="eLabFTW API endpoint URL:", text_font=("", '10','bold'))
        ...
        self.elabftw_endpoint_info = customtkinter.CTkLabel(
            master=self.required_argument_frame,
            text="[Your eLabFTW URL]/api/v1 - please ask the admin.")
        ...
        self.base_output_label = customtkinter.CTkLabel(
            master=self.required_argument_frame, text="Base Output Directory:", text_font=("", '10','bold'))
        ...
        self.base_output_info = customtkinter.CTkLabel(
            master=self.required_argument_frame, text="Local directory to save the outputs.")
        ...
        self.base_output_entry = customtkinter.CTkEntry(
            master=self.required_argument_frame,
            width=295, placeholder_text="Base output directory", border_width=1)
        ...
        self.elabftw_token_label = customtkinter.CTkLabel(
            master=self.required_argument_frame, text="eLabFTW API Token:", anchor=customtkinter.W, text_font=("", '10','bold'))
        ...
        # OPTIONAL ARGS FRAME
        self.optional_label_frame = ttk.LabelFrame(master=self, text="Optional arguments",style="Font.TLabelframe")
        ...
        self.upl_to_elab_switch = customtkinter.CTkSwitch(
            ...
            command=self.switch_event, variable=self.switch_var, onvalue="on", offvalue="off", bg_color="#ebebec")
    ...
    def run_button_event(self):
        ...
        self.output_txtbox = tkinter.Text(master=self, state="normal", width=122, height=30)
